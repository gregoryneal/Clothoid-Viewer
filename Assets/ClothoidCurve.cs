...
namespace Clothoid
{
    ...
    public class ClothoidCurve
    {
        ...
        public System.Numerics.Vector3 Endpoint => SampleCurveFromArcLength(TotalArcLength);
        ...
        public ClothoidCurve AddRandomSegment2()
        {
            ...
            double newArcLength = UnityEngine.Random.Range(5, 9);
        ...
        {
            List<ClothoidSegment> segments = new();
