...
namespace Clothoid {
    ...
    public class ClothoidCurve {
        ...
        public float EndpointAngle { get; private set; }
        ...
        public ClothoidCurve AddSegment(ClothoidSegment newSegment) {
            ...
            this.EndpointAngle += newSegment.Rotation;
            return this;
        }
        ...
        public static ClothoidCurve FromSegments(List<ClothoidSegment> segments)
        {
            ClothoidCurve curve = new ClothoidCurve();
            return curve.AddSegments(segments.ToArray());
        }
